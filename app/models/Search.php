...
class Search extends records
{
    public function rules()
    {
        return [
            ...
            [['ahca_num', 'med_rec_num', 'ssn', 'dob', 'zip', 'visit_begin_date', 'visit_end_date', 'arrival_hour', 'prin_proc_icd9_code'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'ahca_num', $this->ahca_num])
            ...
            ->andFilterWhere(['like', 'prin_proc_icd9_code', $this->prin_proc_icd9_code]);
