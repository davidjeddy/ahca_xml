...
class Search extends records
{
    public function rules()
    {
        return [
            ...
            [['ahca_num', 'med_rec_num', 'ssn', 'dob', 'zip', 'attending_pract_id', 'attending_pract_npi', 'operating_pract_id', 'operating_pract_npi', 'other_pract_id', 'other_pract_npi', 'visit_begin_date', 'visit_end_date', 'arrival_hour', 'prin_proc_icd9_code_id'], 'safe'],
        ];
    }
